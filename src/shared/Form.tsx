            ...
            switch (props.type) {
                ...
                case 'validationCode':
                    return <>
                        ...
                        <Button disabled={isCounting.value} class={[s.formItem, s.validationCodeButton]} onClick={props.onClick}>{isCounting.value ? `${count.value}秒后可重新发送` : props.buttonLabel}</Button>
                    </>
                case 'select':
